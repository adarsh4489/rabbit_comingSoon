  ...
  return (
    <div className="w-full mx-auto flex ">
      <div className={`z-50  fixed  top-0 transition-all ease-in-out duration-200 w-full      `}>
        <div className={`flex justify-between w-full backdrop-blur-md ${!lightMode?"bg-gray-50":"bg-gray-500"} bg-opacity-70 px-2 md:px-16 lg:px-44  2xl:px-52 mx-auto  items-center `} >
          <div>
