...
const HutchDropdown = () => {
  return (
    <div className='w-full h-screen  z-50 backdrop-blur-sm'>
            <div className="w-full h-[250px] z-50   gap-4 dark:text-white dark:bg-black bg-opacity-70 backdrop-blur-2xl dark:bg-opacity-5 dark:backdrop-blur-sm  nav-items bg-gray-50" >
