...
const PortfolioDropdown = ({setPortfolioVisible}) => {
  return (
    <div className='w-full h-screen  z-50 backdrop-blur-md'>
            <div className="w-full h-[270px] z-50  gap-4 bg-gray-50 bg-opacity-70 backdrop-blur-md " onMouseEnter={()=>setPortfolioVisible(true)} onMouseLeave={()=>setPortfolioVisible(false)}>
