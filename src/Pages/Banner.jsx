  ...
  return (
    ...
    <div className="w-full z-0 overflow-hidden relative">
      ...
      borderStyle: "solid"  }}>
          ...
          <div className="w-[95%] md:w-[50%] lg:w-[45%] xl:w-[38%] 2xl:w-[35%] bg-gray-50 bg-opacity-40 absolute backdrop-blur-xl flex flex-col gap-2 bottom-16 right-2 sm:right-4 md:right-40 rounded-xl px-5 lg:px-6 py-2 lg:py-3">
            <h3 className="text-5xl font-['katibeh'] mb-[-0.5rem]">What Makes You </h3>
