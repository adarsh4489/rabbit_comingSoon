    ...
    <div className="w-full z-0 overflow-hidden relative">
      ...
      {currentIndex !== 11 ? (
        currentIndex % 2 === 0 ? (
          <div className="w-[98%] md:w-[50%] lg:w-[50%] xl:w-[40%] 2xl:w-[36%] bg-gray-50 bg-opacity-40 absolute backdrop-blur-xl flex flex-col gap-2 2xl:gap-3 bottom-20 md:bottom-16  left-[0.3rem] sm:left[0.75rem] md:left-40 2xl:left-48 rounded-xl px-5 lg:px-6 py-2 lg:py-3 xl:py-4 2xl:py-5 ">
            <h3 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-['katibeh'] xl:mt-[-0.5rem] 2xl:mt-[-0.15rem] mb-[-1rem] xl:mb-[-1rem] 2xl:mb[-1.5rem]">What Makes You </h3>
      ...
      borderStyle: "solid"  }}>
          ...
          <div className="w-[98%] sm:w-[95%] md:w-[50%] lg:w-[45%] xl:w-[40%] 2xl:w-[36%] bg-gray-50 bg-opacity-40 absolute backdrop-blur-xl flex flex-col gap-2 2xl:gap-3 bottom-20 md:bottom-16 right-[0.3rem] sm:right-[0.75rem] md:right-40 2xl:right-48 rounded-xl px-5 lg:px-6 py-2 lg:py-3 xl:py-4 2xl:py-5">
            <h3 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-['katibeh'] xl:mt-[-0.5rem] 2xl:mt-[-0.1rem] mb-[-1rem] xl:mb-[-1rem] 2xl:mb[-1.6rem]">What Makes You </h3>
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-semibold font-['Revelstoke'] engraved-text tracking-wide 2xl:mt-[-1.5rem]"  style={{ color: colorText[currentIndex] }}>{title[currentIndex]}!</h2>
            <p className="text-[10px] md:text-[12px] lg:text-sm  2xl:text-[16px] font-['Inter-Light] text-justify ">{description[currentIndex]}</p>
