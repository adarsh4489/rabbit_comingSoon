...
function Banner({lightMode}) {
  ...
  return (
    ...
    <div className="w-full z-0 overflow-hidden relative">
      ...
      {currentIndex !== 11 ? (
        currentIndex % 2 === 0 ? (
          <div className="w-[95%] md:w-[50%] lg:w-[50%] xl:w-[40%] 2xl:w-[35%] bg-gray-50 bg-opacity-40  absolute backdrop-blur-xl flex flex-col gap-2 2xl:gap-3  bottom-16 left-2 sm:left-4 md:left-40 rounded-xl px-5 lg:px-6 py-2 lg:py-3 xl:py-4 2xl:py-5">
      ...
      borderStyle: "solid"  }}>
          ...
          <div className="w-[95%] md:w-[50%] lg:w-[45%] xl:w-[40%] 2xl:w-[35%] bg-gray-50 bg-opacity-40 absolute backdrop-blur-xl flex flex-col gap-2 2xl:gap-3 bottom-16 right-2 sm:right-4 md:right-40 rounded-xl px-5 lg:px-6 py-2 lg:py-3 xl:py-4 2xl:py-5">
            <h3 className=" text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-['katibeh'] mb-[-0.5rem]">What Makes You </h3>
